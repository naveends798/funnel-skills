...
5. `${CLAUDE_PLUGIN_ROOT}/skills/landing-design/references/design-patterns.md`
...
2. **Run the HTML/CSS generator** via Bash:
   ```bash
   node "${CLAUDE_PLUGIN_ROOT}/skills/landing-design/scripts/generate-sections.mjs" <slug>
   ```
