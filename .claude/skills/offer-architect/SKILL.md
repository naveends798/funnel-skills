...
3. `.claude/skills/offer-architect/references/offer-equation.md` (Hormozi value equation)
4. `.claude/skills/offer-architect/references/pricing-patterns.md` (anchor pricing, charm pricing, decoy)
