...
1. `.claude/skills/funnel-doctor/references/audit-checklist.md` — pre-launch checklist (use as background)
2. `.claude/skills/funnel-doctor/references/post-launch-diagnostics.md` — the data-driven diagnostic patterns
